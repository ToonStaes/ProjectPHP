...
@section('main')
    @guest
        ...
        <p class="font-italic">Deze webapplicatie is ontwikkeld door vijf studenten Toegepaste Informatica van Thomas More te Geel. Het onkostenportaal is een <b>proefproject</b> voor het opleidingsonderdeel "Project PHP".</p>
    @else
    @endguest
