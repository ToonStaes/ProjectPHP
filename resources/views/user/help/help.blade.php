...
@section('main')
    <div class="help container">
        <h1 class="text-center">Help <i class="fas fa-info-circle" data-toggle="tooltip" data-placement="right" title="Op deze pagina kan u hulp vinden voor alle pagina's van het onkostenportaal."></i></h1>
